...
var ICONS = {
  add: async () => (await import("./add-D2EUTSTT.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-EYANE2DE.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-I6NDPHPY.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-IHIABCN3.js")).appStoreSvg,
  apple: async () => (await import("./apple-OYPCLPX2.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-TXXNFXWH.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-R65VQFS3.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-HG7OHGLW.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-2SPAASID.js")).arrowTopSvg,
  bank: async () => (await import("./bank-YKFFCRBQ.js")).bankSvg,
  browser: async () => (await import("./browser-AVMGQ337.js")).browserSvg,
  bin: async () => (await import("./bin-BULB374V.js")).binSvg,
  bitcoin: async () => (await import("./bitcoin-26LDUNNR.js")).bitcoinSvg,
  card: async () => (await import("./card-Z4IV4FRI.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-UNY3DPM6.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-ECTE7IUE.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-DHPDQWVU.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-DQ5WUUKV.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-UZ7GM42V.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-TEKVLHG4.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-IKJKA3OJ.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-WW4GWEBQ.js")).clockSvg,
  close: async () => (await import("./close-GCTBQQZY.js")).closeSvg,
  compass: async () => (await import("./compass-ZWMXS4NJ.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-6YTRUORQ.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-PSSNVE7U.js")).copySvg,
  cursor: async () => (await import("./cursor-MMEIJ25E.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-2IQMSFRI.js")).cursorTransparentSvg,
  circle: async () => (await import("./circle-MTLQ5ZVI.js")).circleSvg,
  desktop: async () => (await import("./desktop-FUEJVAU4.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-WOC7TPAN.js")).disconnectSvg,
  discord: async () => (await import("./discord-RMGVPMB5.js")).discordSvg,
  ethereum: async () => (await import("./ethereum-LLQ7DTKE.js")).ethereumSvg,
  etherscan: async () => (await import("./etherscan-FR3CTBEV.js")).etherscanSvg,
  extension: async () => (await import("./extension-Z77JI2F6.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-CKBOL3M5.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-BGFLRYG3.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-JLE25P7G.js")).farcasterSvg,
  filters: async () => (await import("./filters-XBCGIH6J.js")).filtersSvg,
  github: async () => (await import("./github-5MZ3IR4A.js")).githubSvg,
  google: async () => (await import("./google-TCCGNOJ4.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-ZPECGAAJ.js")).helpCircleSvg,
  image: async () => (await import("./image-QHMFKQQO.js")).imageSvg,
  id: async () => (await import("./id-ANEQGORG.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-GKUR4QQO.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-UCHCJ3DR.js")).lightbulbSvg,
  mail: async () => (await import("./mail-VSZRHPBY.js")).mailSvg,
  mobile: async () => (await import("./mobile-RTVUPRBS.js")).mobileSvg,
  more: async () => (await import("./more-2ZIKZRAI.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-ENLUG3UR.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-EAOHWUA7.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-FF6FTXPW.js")).offSvg,
  playStore: async () => (await import("./play-store-ZGDLW3BJ.js")).playStoreSvg,
  plus: async () => (await import("./plus-B6C3I7FM.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-BNM42HKJ.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-DVVHOYHI.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-6FGRNPRG.js")).refreshSvg,
  search: async () => (await import("./search-BPIASIS4.js")).searchSvg,
  send: async () => (await import("./send-OJP5DGZM.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-37PRACFA.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-PH3LLZ7M.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-Z7KXYOOJ.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-7C5DUQ3N.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-EFZFAFFW.js")).swapVerticalSvg,
  solana: async () => (await import("./solana-GDN3HN3M.js")).solanaSvg,
  telegram: async () => (await import("./telegram-Y6GYJ56A.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-UFFK45O2.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-4T5EMKWK.js")).twitchSvg,
  twitter: async () => (await import("./x-5OL4JXAE.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-VFTINKDC.js")).twitterIconSvg,
  user: async () => (await import("./user-MTDPQZWF.js")).userSvg,
  verify: async () => (await import("./verify-2MCNM6HY.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-X6TAMICN.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-WDSJJGRV.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-VFYEYQTV.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-VFYEYQTV.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-VFYEYQTV.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-E5VEITFW.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-7RLVGEXF.js")).warningCircleSvg,
  x: async () => (await import("./x-5OL4JXAE.js")).xSvg,
  info: async () => (await import("./info-5OAFUSUH.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-63PFCWKV.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-F2X3CTFH.js")).reownSvg,
  "x-mark": async () => (await import("./x-mark-GBPORAMW.js")).xMarkSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-SD5E372F.js.map
