...
import {
  ...
  vi
} from "./chunk-OBLB66M2.js";
import {
  bootstrapLazy
} from "./chunk-HXMLXKYS.js";
import "./chunk-LHTHZIPF.js";
import "./chunk-KPEVJZ4S.js";
...
var require_utils = __commonJS({
  "node_modules/@noble/hashes/utils.js"(exports) {
    ...
    var hexes5 = Array.from({ length: 256 }, (v2, i) => i.toString(16).padStart(2, "0"));
    ...
    var SHA2562 = class extends _sha2_js_1.SHA2 {
      ...
      process(view, offset) {
        ...
        for (let i = 0; i < 64; i++) {
          ...
          const T1 = H2 + sigma1 + Chi2(E2, F2, G2) + SHA256_K2[i] + SHA256_W2[i] | 0;
...
var JacobianPoint = class _JacobianPoint {
  ...
  double() {
    ...
    const C2 = mod(B2 * B2);
    const x1b = X1 + B2;
    const D2 = mod(_2n * (mod(x1b * x1b) - A - C2));
    const E2 = mod(_3n * A);
    const F2 = mod(E2 * E2);
...
var Point = class _Point {
  ...
  static fromSignature(msgHash, signature, recovery) {
    ...
    const Q2 = _Point.BASE.multiplyAndAddUnsafe(R2, u1, u2);
    if (!Q2)
...
function invert(number2, modulo = CURVE.P) {
  ...
  let b2 = modulo;
  let x2 = _0n, y = _1n, u2 = _1n, v2 = _0n;
  while (a !== _0n) {
    const q2 = b2 / a;
    const r = b2 % a;
    const m = x2 - u2 * q2;
    const n = y - v2 * q2;
    b2 = a, a = r, x2 = u2, y = v2, u2 = m, v2 = n;
  }
  const gcd = b2;
  if (gcd !== _1n)
...
function clTuple() {
  const tupleCurly = chain([
    ...
    greedy(1, sequence([
      ...
      whitespace(),
      clValue()
    ], ([k, v2]) => cl_exports.tuple({ [k]: v2 })), (c) => cl_exports.tuple(Object.assign({}, ...c.map((t) => t.value))), regex(/\s*\,\s*/)),
    regex(/\}/)
  ]);
  const tupleFunction = parens(sequence([
    ...
    greedy(1, parens(sequence([
      ...
      clValue(),
      optional(whitespace())
    ], ([k, v2]) => cl_exports.tuple({ [k]: v2 }))), (c) => cl_exports.tuple(Object.assign({}, ...c.map((t) => t.value))), whitespace())
  ]));
...
utils.hmacSha256Sync = (key, ...msgs) => {
  const h2 = hmac.create(sha2562, key);
...
function intToBigInt2(value, signed) {
  ...
  if (parsedValue instanceof Uint8Array) {
    if (signed) {
      const bn = fromTwos(BigInt(`0x${bytesToHex3(parsedValue)}`), BigInt(parsedValue.byteLength * 8));
...
var AppKitBaseClient = class {
  constructor(options) {
    ...
    this.setConnectedWalletInfo = (connectedWalletInfo, chain2) => {
      const type = ProviderUtil.getProviderId(chain2);
  ...
  createClients() {
    this.connectionControllerClient = {
      ...
      connectExternal: async ({ id, address: address2, info, type, provider, chain: chain2, caipNetwork, socialUri }) => {
        var _a, _b, _c, _d, _e2, _f;
        const activeChain = ChainController.state.activeChain;
      ...
      disconnect: async (params) => {
        ...
        try {
          ...
          const disconnectPromises = namespacesToDisconnect.map(async (ns2) => {
            const connectorIdToDisconnect = ConnectorController.getConnectorId(ns2);
            const disconnectData = await this.disconnectNamespace(ns2, connectorIdParam || connectorIdToDisconnect);
            if (disconnectData) {
              if (isAuth) {
...
var AppKit = class extends AppKitBaseClient {
  ...
  async injectModalUi() {
    if (!isInitialized && CoreHelperUtil.isClient()) {
      await import("./basic-46I4G5ED.js");
      await import("./w3m-modal-5RQDPSWF.js");
...
var fe = (e2, t, s) => t in e2 ? Ke(e2, t, { enumerable: true, configurable: true, writable: true, value: s }) : e2[t] = s;
var u = (e2, t) => {
  for (var s in t || (t = {}))
    me.call(t, s) && fe(e2, s, t[s]);
  if (j)
    for (var s of j(t))
      Ie.call(t, s) && fe(e2, s, t[s]);
  return e2;
};
var p = (e2, t) => Je(e2, $e(t));
var ye = (e2, t) => {
  var s = {};
  for (var o in e2)
    me.call(e2, o) && t.indexOf(o) < 0 && (s[o] = e2[o]);
  if (e2 != null && j)
    for (var o of j(e2))
      t.indexOf(o) < 0 && Ie.call(e2, o) && (s[o] = e2[o]);
  return s;
};
...
var Ne = ((c) => (c[c.ParseError = -32700] = "ParseError", c[c.InvalidRequest = -32600] = "InvalidRequest", c[c.MethodNotFound = -32601] = "MethodNotFound", c[c.InvalidParams = -32602] = "InvalidParams", c[c.InternalError = -32603] = "InternalError", c[c.UserRejection = -32e3] = "UserRejection", c[c.MethodAddressMismatch = -32001] = "MethodAddressMismatch", c[c.MethodAccessDenied = -32002] = "MethodAccessDenied", c[c.UnknownError = -31e3] = "UnknownError", c[c.UserCanceled = -31001] = "UserCanceled", c))(Ne || {});
var Ce = "asigna-stx";
var z = (e2, t) => new Promise((s) => {
  function o(n) {
    n.data.source === Ce && n.data[t] && (s(n.data[t]), window.removeEventListener("message", o));
  }
  window.addEventListener("message", o), window.top.postMessage(tt(e2, t), "*");
});
var et = { authenticationRequest: async (e2) => z(e2, "authenticationRequest"), transactionRequest: async (e2) => z(e2, "transactionRequest"), request: async (e2, t) => z(t, e2) };
var tt = (e2, t) => ({ source: Ce, [t]: e2 });
var De = () => {
  if (typeof window == "undefined")
    return;
  window.top !== window.self && (window.AsignaProvider = et);
};
De();
...
function E(e2) {
  return e2 ? typeof e2 == "string" ? e2 : O(e2, StacksMainnet) ? "mainnet" : O(e2, StacksTestnet) ? "testnet" : O(e2, StacksDevnet) || O(e2, StacksMocknet) ? "devnet" : "coreApiUrl" in e2 ? e2.coreApiUrl : "url" in e2 ? e2.url : "transactionVersion" in e2 ? e2.transactionVersion === TransactionVersion.Mainnet ? "mainnet" : "testnet" : "mainnet" : "mainnet";
}
function C(e2) {
  ...
  switch (e2.type) {
    ...
    case ClarityType2.List:
      return cl_exports.list(e2.list.map(C));
    case ClarityType2.Tuple:
      return cl_exports.tuple(Object.fromEntries(Object.entries(e2.data).map(([s, o]) => [s, C(o)])));
    case ClarityType2.OptionalNone:
      return cl_exports.none();
    case ClarityType2.OptionalSome:
      return cl_exports.some(C(e2.value));
    case ClarityType2.ResponseErr:
      return cl_exports.error(C(e2.value));
    case ClarityType2.ResponseOk:
      return cl_exports.ok(C(e2.value));
    case ClarityType2.PrincipalContract:
...
function we(e2) {
  return p(u({}, e2), { onFinish: void 0, onCancel: void 0 });
}
function ct(e2) {
}
var dt = async (e2) => {
};
var ut = "stx_updateProfile";
var B = (e2) => e2;
var F = (e2) => e2.profile;
function pt(e2, t = S()) {
  f2(ut, B, F)(e2, t);
...
var mt = "stx_signStructuredMessage";
var Z = (e2) => ({ message: C(e2.message), domain: C(e2.domain) });
var X = (e2) => e2;
function It(e2, t = S()) {
  if (e2.domain.type !== ClarityType2.Tuple)
    throw new Error("Domain must be a tuple");
  f2(mt, Z, X)(e2, t);
}
var Ee = (e2) => {
  let t = e2;
  if (!t) {
    let s = new b(["store_write"], document.location.href);
    t = new D({ appConfig: s });
  }
  return t;
};
function Ct(e2) {
  try {
    return Ee(e2).loadUserData().appPrivateKey;
  } catch (t) {
    return false;
  }
}
...
function xt(e2) {
  ...
  if (!s || !o)
    return;
  let n = (d = s == null ? void 0 : s.loadUserData().profile) == null ? void 0 : d.stxAddress, r = { [ChainId.Mainnet]: "mainnet", [ChainId.Testnet]: "testnet" }, a = Pe(o);
...
var ht = "stx_callContract";
var H = (e2) => {
  var s;
  let t = (s = e2.functionArgs) == null ? void 0 : s.map((o) => typeof o == "string" ? cl_exports.deserialize(o) : C(o)).map((o) => cl_exports.serialize(o));
  return p(u({}, e2), { contract: `${e2.contractAddress}.${e2.contractName}`, functionArgs: t, network: E(e2.network), postConditionMode: be(e2.postConditionMode), postConditions: ke(e2.postConditions), address: e2.stxAddress });
};
var V = (e2) => ({ txId: e2.txid, txRaw: e2.transaction, stacksTransaction: deserializeTransaction(e2.transaction) });
function jt(e2, t = S()) {
  f2(ht, H, V)(e2, t);
}
var Ot = "stx_deployContract";
var K = (e2) => p(u({}, e2), { name: e2.contractName, clarityCode: e2.codeBody, network: E(e2.network), postConditionMode: be(e2.postConditionMode), postConditions: ke(e2.postConditions), address: e2.stxAddress });
var J = (e2) => ({ txId: e2.txid, txRaw: e2.transaction, stacksTransaction: deserializeTransaction(e2.transaction) });
function Et(e2, t = S()) {
  f2(Ot, K, J)(e2, t);
}
var kt = "stx_transferStx";
var $ = (e2) => p(u({}, e2), { amount: e2.amount.toString(), network: E(e2.network), address: e2.stxAddress });
var ee = (e2) => ({ txId: e2.txid, txRaw: e2.transaction, stacksTransaction: deserializeTransaction(e2.transaction) });
function bt(e2, t = S()) {
  f2(kt, $, ee)(e2, t);
}
var Rt = "stx_signTransaction";
var te = (e2) => p(u({}, e2), { transaction: e2.txHex });
var se = (e2) => p(u({}, e2), { stacksTransaction: deserializeTransaction(e2.transaction) });
function _t(e2, t = S()) {
  f2(Rt, te, se)(e2, t);
}
function ke(e2) {
  if (typeof e2 != "undefined")
    return e2.map((t) => typeof t == "string" ? t : typeof t.type == "string" ? p(u({}, t), { amount: "amount" in t ? t.amount.toString() : void 0 }) : bytesToHex(serializePostCondition(t)));
}
function be(e2) {
  if (typeof e2 != "undefined") {
    if (typeof e2 == "string")
...
function x(e2, t, s) {
  return (o, n) => {
    let r = t(we(o)), a = o;
    P({ provider: n }, e2, r).then((i) => {
      var M;
      let d = s(i);
      (M = a.onFinish) == null || M.call(a, d);
    }).catch((i) => {
      var d;
      console.error(i), (d = a.onCancel) == null || d.call(a, i);
    });
  };
}
var vt = _e;
var go = x("stx_transferStx", $, ee);
var So = x("stx_callContract", H, V);
var Ao = x("stx_deployContract", K, J);
var fo = x("stx_signTransaction", te, se);
var mo = x("stx_updateProfile", B, F);
var Io = x("stx_signMessage", Q, q);
var yo = x("stx_signStructuredMessage", Z, X);
var No = vt;
var oe = "@stacks/connect";
var Bt = { addresses: { stx: [], btc: [] }, version: "0.0.1" };
var ve = (e2) => [...new Map(e2.map((s) => [s.address, s])).values()].map((o) => {
  var s = ye(o, []);
...
function Ue(e2) {
  try {
    let s = ne() || Bt, o = p(u({}, s), { updatedAt: Date.now(), addresses: u(u({}, s.addresses), e2.addresses && { stx: e2.addresses.stx && ve([...s.addresses.stx, ...e2.addresses.stx]), btc: e2.addresses.btc && ve([...s.addresses.btc, ...e2.addresses.btc]) }) });
    localStorage.setItem(oe, bytesToHex(utf8ToBytes(JSON.stringify(o))));
  } catch (t) {
...
function ne() {
  try {
    let e2 = localStorage.getItem(oe);
...
function Ft() {
  let e2 = getProvider();
  e2 && "disconnect" in e2 && e2.disconnect(), clearSelectedProviderId(), ze(), new D().store.deleteSessionData();
}
function Qt() {
  let e2 = ne();
  return (e2 == null ? void 0 : e2.addresses.stx.length) > 0 || (e2 == null ? void 0 : e2.addresses.btc.length) > 0;
}
var Zt = ["stx_signMessage", "stx_signTransaction", "stx_signStructuredMessage", "stx_getAccounts", "stx_getAddresses", "stx_updateProfile", "stx_transferStx", "stx_transferSip10Ft", "stx_transferSip9Nft", "stx_callContract", "stx_deployContract", "sendTransfer", "signPsbt", "getAddresses"];
var h = { id: 1, chainNamespace: "stacks", caipNetworkId: "stacks:1", name: "Stacks", nativeCurrency: { name: "STX", symbol: "STX", decimals: 6 }, rpcUrls: { default: { http: ["https://api.mainnet.hiro.so"] } } };
var re = { id: 2, chainNamespace: "stacks", caipNetworkId: "stacks:2147483648", name: "Stacks Testnet", nativeCurrency: { name: "STX", symbol: "STX", decimals: 6 }, rpcUrls: { default: { http: ["https://api.testnet.hiro.so"] } } };
var Ye = { metadata: { name: "Universal Connector", description: "Universal Connector", url: "https://appkit.reown.com", icons: ["https://appkit.reown.com/icon.png"] }, networks: [{ namespace: "stacks", chains: [h, re], methods: Zt, events: ["stx_chainChanged", "stx_accountsChanged"] }, { namespace: "bip122", chains: [bitcoin], methods: ["signMessage", "sendTransfer", "signPsbt", "getAccountAddresses"], events: ["bip122_addressesChanged"] }] };
function Ge(e2) {
...
var ie = class {
  ...
  get stacksAddresses() {
    var a;
    let t = (a = this.connector.provider) == null ? void 0 : a.session, s = t == null ? void 0 : t.sessionProperties.stacks_getAddresses, o = JSON.parse(s || "[]"), r = [...t.namespaces.stacks.accounts.map((i) => ({ address: i.split(":")[2], publicKey: "" })) || [], ...o || []].sort((i) => i.publicKey ? 1 : -1);
    return Array.from(new Map(r.map((i) => [i.address, i])).values());
  }
  get btcAddresses() {
    var a;
    let t = (a = this.connector.provider) == null ? void 0 : a.session, s = t == null ? void 0 : t.sessionProperties.bip122_getAccountAddresses, o = JSON.parse(s || "{}"), n = t.namespaces.bip122.accounts.map((i) => ({ address: i.split(":")[2], publicKey: "" })), r = [...(o == null ? void 0 : o.payment.map((i) => p(u({}, i), { purpose: "payment" }))) || [], ...(o == null ? void 0 : o.ordinal.map((i) => p(u({}, i), { purpose: "ordinal" }))) || [], ...n || []].sort((i) => i.publicKey ? 1 : -1).sort((i, d) => (i == null ? void 0 : i.address.length) - (d == null ? void 0 : d.address.length));
    return Array.from(new Map(r.map((i) => [i.address, i])).values());
  }
  async getAddresses() {
    var r;
  ...
  validateRpcMethod(t) {
    var i, d, M, c;
    if (["getAddresses", "stx_getAccounts", "stx_getAddresses"].includes(t))
      return;
    if (!((i = this.connector.provider) != null && i.session))
      throw new Error("WalletConnectProvider not connected. Please connect first.");
    let o = (d = this.connector.provider) == null ? void 0 : d.session.namespaces, n = ((M = o.stacks) == null ? void 0 : M.methods) || [], r = ((c = o.bip122) == null ? void 0 : c.methods) || [];
    if (![...n, ...r].includes(t))
  ...
  getTargetCaipNetworkId(t, s) {
    ...
    if (n)
      return { mainnet: h.caipNetworkId, testnet: re.caipNetworkId }[n];
    if (o.includes(t))
      return h.caipNetworkId;
    if ((d = (i = (a = (r = this.connector.provider) == null ? void 0 : r.session) == null ? void 0 : a.namespaces) == null ? void 0 : i.stacks) != null && d.methods.includes(t))
      return h.caipNetworkId;
    if ((I = (A = (c = (M = this.connector.provider) == null ? void 0 : M.session) == null ? void 0 : c.namespaces) == null ? void 0 : A.bip122) != null && I.methods.includes(t))
  ...
  async request(t, s) {
    ...
    try {
      ...
      let i = this.getTargetCaipNetworkId(t, s);
      switch (t) {
        case "getAddresses":
        case "stx_getAddresses":
        case "stx_getAccounts":
          let d = await this.getAddresses();
          return Ge(d);
        case "stx_signMessage":
          let c = ((a = (r = (n = (o = this.connector.provider) == null ? void 0 : o.session) == null ? void 0 : n.namespaces) == null ? void 0 : r.stacks) == null ? void 0 : a.accounts[0]).split(":")[2], A = await this.connector.request({ method: t, params: u({ address: c }, s) }, i);
          return Ge(A);
        default:
          return await this.connector.request({ method: t, params: s }, i);
      }
    } catch (i) {
      throw console.error(">> WalletConnectProvider request error", i), i;
    }
  }
  async disconnect() {
...
async function ae(e2) {
  let { projectId: t, config: s } = typeof e2 == "string" ? { projectId: e2, config: void 0 } : { projectId: e2.projectId, config: e2 }, o = await UniversalConnector.init(p(u(u({}, Ye), s), { projectId: t })), n = new ie(o);
  window.WalletConnectProvider = n;
}
async function _(e2, t, s) {
  var o;
  try {
    let n = await e2.request(t, s);
    if (!n)
      throw new N("Provider did not return a response", -31e3);
    if ("error" in n)
      throw N.fromResponse(n.error);
    return n.result;
  } catch (n) {
    if (n instanceof N)
      throw n;
    ...
    throw new N(n.message, r, n.data, n);
  }
}
function os(e2) {
  return e2 ? async function(s, o, n) {
    ...
    if ((o === "getAddresses" || o === "wallet_connect") && "addresses" in r) {
      let { stx: a, btc: i } = ps(r.addresses).reduce((d, M) => (d[M.address.startsWith("S") ? "stx" : "btc"].push(M), d), { stx: [], btc: [] });
      Ue({ addresses: { stx: a, btc: i } });
    }
    return r;
  } : _;
}
async function P(...e2) {
  let { options: t, method: s, params: o } = ns(e2), n = Object.assign({ provider: getProvider(), defaultProviders: xe, forceWalletSelect: false, persistWalletSelect: true, enableOverrides: true, enableLocalStorage: true }, cs(t));
  n != null && n.walletConnect ? (await ae(n.walletConnect).catch(console.error), n.defaultProviders = [...n.defaultProviders, Y]) : n != null && n.walletConnectProjectId && (await ae(n.walletConnectProjectId).catch(console.error), n.defaultProviders = [...n.defaultProviders, Y]);
  let r = ds(n.enableOverrides, os(n.enableLocalStorage));
  if (n.provider && !n.forceWalletSelect) {
    let { method: a, params: i } = ce(n.provider, s, o, n.enableOverrides);
    return await r(n.provider, a, de(i));
  }
  if (typeof window != "undefined")
    return defineCustomElements(window), new Promise((a, i) => {
      let d = document.createElement("connect-modal");
      d.defaultProviders = Fe(n.approvedProviderIds, n.defaultProviders), d.installedProviders = Fe(n.approvedProviderIds, getInstalledProviders(n.defaultProviders));
      let M = document.body.style.overflow;
      document.body.style.overflow = "hidden";
      let c = () => {
        d.remove(), document.body.style.overflow = M;
      };
      d.callback = (I) => {
        c();
        let T = getProviderFromId(I), { method: y, params: w } = ce(T, s, o, n.enableOverrides), U = us(n.persistWalletSelect, I);
        a(r(T, y, de(w)).then(U));
      }, d.cancelCallback = () => {
        c(), i(new N("User canceled the request", -31001));
      }, document.body.appendChild(d);
      let A = (I) => {
        I.key === "Escape" && (document.removeEventListener("keydown", A), d.remove(), i(new N("User canceled the request", -31001)));
      };
...
function rs(e2) {
  ...
  return P(p(u({}, e2), { forceWalletSelect: true }), "getAddresses", t);
}
function f2(e2, t, s) {
  return (o, n) => {
    if (!n)
      throw new Error("[Connect] No installed Stacks wallet found");
    let r = t(o), a = o, { method: i, params: d } = ce(n, e2, r);
    _(n, i, de(d)).then((M) => {
      var A;
      let c = s(M);
      (A = a.onFinish) == null || A.call(a, c);
    }).catch(a.onCancel);
  };
}
function R(e2) {
...
function ce(e2, t, s, o = true) {
  if (!o)
    return { method: t, params: s };
  if (R(e2) && ["getAddresses", "stx_getAddresses"].includes(t))
    return { method: "wallet_connect", params: s };
  if (R(e2) && t === "sendTransfer") {
    let n = p(u({}, s), { recipients: s.recipients.map((r) => p(u({}, r), { amount: Number(r.amount) })), network: void 0 });
  ...
  if (R(e2) && t === "signPsbt") {
    ...
    let r = {};
    for (let i of n)
      typeof i != "number" && i.address && (r[i.address] || (r[i.address] = []), r[i.address].push(i.index));
    let a = { psbt: s.psbt, signInputs: r, broadcast: s.broadcast };
    return { method: t, params: a };
  }
  if (!R(e2) && t === "stx_signMessage") {
    let n = u({}, s);
    return delete n.publicKey, { method: t, params: n };
  }
  if (Qe(e2) && t === "sendTransfer") {
    let n = p(u({}, s), { recipients: s.recipients.map((r) => p(u({}, r), { amount: r.amount.toString() })) });
    return { method: t, params: n };
  }
  if (Qe(e2) && t === "signPsbt") {
...
var qe = ["stx-postcondition", "ft-postcondition", "nft-postcondition"];
function de(e2) {
  ...
  for (let [s, o] of Object.entries(e2)) {
    ...
    if (o) {
      if (Array.isArray(o)) {
        t[s] = o.map((n) => typeof n == "bigint" ? n.toString() : !n || typeof n != "object" || !("type" in n) ? n : qe.includes(n.type) ? postConditionToHex(n) : cl_exports.serialize(n));
        continue;
      }
      typeof o == "object" && "type" in o && (t[s] = qe.includes(o.type) ? postConditionToHex(o) : cl_exports.serialize(o));
    }
  }
...
var _e = async (e2, t) => {
  var a, i, d, M, c, A;
  let { onFinish: s, onCancel: o, userSession: n } = e2, r = He(n);
  r.isUserSignedIn() && r.signUserOut();
  try {
    let T = await P({ provider: t, forceWalletSelect: true }, "getAddresses"), y = r.store.getSessionData();
    (a = y.userData) != null || (y.userData = { profile: {} }), (d = (i = y.userData).profile) != null || (i.profile = {}), (c = (M = y.userData.profile).stxAddress) != null || (M.stxAddress = { mainnet: "", testnet: "" });
    let w = T.addresses.find((m) => (m == null ? void 0 : m.symbol) === "STX" || m.address.startsWith("S")).address.toUpperCase(), U = w[1] === "P" || w[1] === "M";
    Object.assign(y.userData.profile.stxAddress, { [U ? "mainnet" : "testnet"]: w });
    let ge = (A = T.addresses.find((m) => {
      var Se;
      return (Se = m == null ? void 0 : m.address) != null && Se.startsWith("S") ? false : m.purpose === "payment" ? true : Xe(m == null ? void 0 : m.address) ? T.addresses.every((L) => {
        var Ae;
        return ((Ae = L == null ? void 0 : L.address) == null ? void 0 : Ae.startsWith("S")) || Xe(L == null ? void 0 : L.address);
      }) : true;
    })) == null ? void 0 : A.address;
    ge && (y.userData.profile.btcAddress = ge), r.store.setSessionData(y), s == null || s({ userSession: r, authResponsePayload: y.userData });
  } catch (I) {
    console.error("[Connect] Error during auth request", I), o == null || o(I);
  }
};
var Ms = "blockstack-session";
var b = class {
  constructor(t, s, o, n, r, a) {
  }
};
var D = class {
  constructor(t) {
    t != null && t.appConfig && (this.appConfig = t.appConfig), typeof window == "undefined" && typeof self == "undefined" ? this.store = new ue() : this.store = new pe();
  }
  ...
  loadUserData() {
    ...
    if (!t)
      throw new NoSessionDataError("No user data found. Did the user sign in?");
    return t;
  }
  encryptContent() {
  }
...
var pe = class extends v {
  constructor(t) {
    var o;
    super(t), this.key = typeof ((o = t == null ? void 0 : t.storeOptions) == null ? void 0 : o.localStorageKey) == "string" ? t.storeOptions.localStorageKey : Ms, localStorage.getItem(this.key) || this.setSessionData({});
  }
  getSessionData() {
...
var He = (e2) => e2 || new D();
var sn = async (e2) => (e2 = He(e2), e2.isUserSignedIn() ? Promise.resolve(e2.loadUserData()) : Promise.resolve(null));
function Xe(e2) {
  let t = ["bc1p", "tb1p", "bcrt1p"], s = [62, 62, 64], o = t.findIndex((n) => e2.startsWith(n));
  return o === -1 ? false : e2.length === s[o];
}
var ls = ((o) => (o.ContractCall = "contract_call", o.ContractDeploy = "smart_contract", o.STXTransfer = "token_transfer", o))(ls || {});
var gs = ((r) => (r.BUFFER = "buffer", r.UINT = "uint", r.INT = "int", r.PRINCIPAL = "principal", r.BOOL = "bool", r))(gs || {});
var le = ((r) => (r[r.DEFAULT = 0] = "DEFAULT", r[r.ALL = 1] = "ALL", r[r.NONE = 2] = "NONE", r[r.SINGLE = 3] = "SINGLE", r[r.ANYONECANPAY = 128] = "ANYONECANPAY", r))(le || {});
function fs(e2) {
}
var ms = async (e2) => {
};
...
var ys = (e2) => {
  var t;
  return { psbt: base64.encode(hexToBytes(e2.hex)), signInputs: typeof e2.signAtIndex == "number" ? [e2.signAtIndex] : e2.signAtIndex, allowedSighash: (t = e2.allowedSighash) == null ? void 0 : t.map((s) => le[s]) };
};
var Ns = (e2) => ({ hex: bytesToHex(base64.decode(e2.psbt)) });
function Cs(e2, t = S()) {
  f2(Is, ys, Ns)(e2, t);
}
export {
  b as AppConfig,
  gs as ContractCallArgumentType,
  xe as DEFAULT_PROVIDERS,
  ue as InstanceDataStore,
  N as JsonRpcError,
  Ne as JsonRpcErrorCode,
  Ms as LOCALSTORAGE_SESSION_KEY,
  pe as LocalStorageStore,
  v as SessionDataStore,
  le as SignatureHash,
  ls as TransactionTypes,
  D as UserSession,
  Y as WALLET_CONNECT_PROVIDER,
  _e as authenticate,
  ze as clearLocalStorage,
  clearSelectedProviderId,
  rs as connect,
  en as defaultAuthURL,
  Ft as disconnect,
  ct as getDefaultProfileUpdateRequestOptions,
  fs as getDefaultPsbtRequestOptions,
  Mt as getDefaultSignatureRequestOptions,
  Dt as getKeys,
  ne as getLocalStorage,
  He as getOrCreateUserSession,
  getProvider as getSelectedProvider,
  getSelectedProviderId,
  S as getStacksProvider,
  xt as getStxAddress,
  sn as getUserData,
  Ee as getUserSession,
  Ct as hasAppPrivateKey,
  Xe as isAddressTaproot,
  Qt as isConnected,
  tn as isMobile,
  isProviderSelected,
  at as isStacksWalletInstalled,
  Tt as makeContractCallToken,
  Lt as makeContractDeployToken,
  dt as makeProfileUpdateToken,
  ms as makePsbtToken,
  Pt as makeSTXTransferToken,
  wt as makeSignTransaction,
  jt as openContractCall,
  Et as openContractDeploy,
  pt as openProfileUpdateRequestPopup,
  Cs as openPsbtRequestPopup,
  bt as openSTXTransfer,
  _t as openSignTransaction,
  St as openSignatureRequestPopup,
  It as openStructuredDataSignatureRequestPopup,
  P as request,
  _ as requestRaw,
  setSelectedProviderId,
  No as showBlockstackConnect,
  vt as showConnect,
  So as showContractCall,
  Ao as showContractDeploy,
  mo as showProfileUpdate,
  go as showSTXTransfer,
  Io as showSignMessage,
  yo as showSignStructuredMessage,
  fo as showSignTransaction,
  lt as signMessage,
  ft as signStructuredMessage
};
